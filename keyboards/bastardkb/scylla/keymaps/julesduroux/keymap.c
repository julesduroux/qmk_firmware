...
#define FR_FN MO(2)	// function layer
#define FR_SHIFT MO(3) // shift but pimped layer
#define FR_SALT MO(4)	// shift + alt layer
...
//-----------------------------------------------------------//-----------------------------------------------------------//
    KC_LCTL, FR_W, FR_X, FR_C, FR_V, FR_LABK,						FR_ASTR, FR_B, FR_N, FR_COMM, FR_SCLN, FR_EXLM,
//-----------------------------------------------------------//-----------------------------------------------------------//
